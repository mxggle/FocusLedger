...
/** Download entry points — wired to the v0.7.1 release assets. */
const REL = "https://github.com/mxggle/yolo/releases/download/v0.7.1";
export const DOWNLOAD = {
  releases: "https://github.com/mxggle/yolo/releases/latest",
  mac: `${REL}/Yolo_0.7.1_universal.dmg`,
  windows: `${REL}/Yolo_0.7.1_x64-setup.exe`,
